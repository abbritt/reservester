...
ActiveRecord::Schema.define(version: 20170612155826) do
  ...
  create_table "b_users", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_b_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_b_users_on_reset_password_token", unique: true
  end
